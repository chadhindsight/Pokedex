    ...
    return (
        <div className="home">
           <p className='intro'>
                ...
                a series of video games developed by Game Freak and published by Nintendo and The Pokémon Company as part of the Pokémon media franchise. Created by Satoshi Tajiri with assistance from Ken Sugimori, the first games released in 1996 in Japan for the Game Boy, and the main series of role-playing video games (RPGs), also referred as the "core series" by their developers. 
                Since 1996, the games have continued to be release on each generation of Nintendo's handhelds and
                 also branced off into different mediato become  the highest-grossing media franchise of all time. 
                 This site gives you a platform to celebrate and share your love of Pokémon with others from all around the world.            
                </p>
